...
import com.example.pradeshadvkotlin.BuildConfig
import com.example.pradeshadvkotlin.PradeshAdv
import com.example.pradeshadvkotlin.utils.Helpers
...
class HttpClient {
    ...
    private fun buildRetrofitClient() {
        val token = PradeshAdv.getApp().getToken()
    ...
    fun buildRetrofitClient(token : String?){
        ...
        if (BuildConfig.DEBUG) {
           ...
           builder.addInterceptor(ChuckerInterceptor(PradeshAdv.getApp()))
        }
